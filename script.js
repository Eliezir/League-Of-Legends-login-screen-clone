...
checkBoxEffects.addEventListener('change',function() {
if(checkBoxEffects.checked){
  document.querySelector("#wallpaper-live").classList.add("wallpaper-static")
}
else{
  document.querySelector("#wallpaper-live").classList.remove("wallpaper-static")
}})
